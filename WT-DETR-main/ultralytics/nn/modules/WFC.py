...
class WTConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=5, stride=1, bias=True, wt_levels=2, wt_type='db1'):
        ...
        # self.conv = Conv(in_channels, in_channels, 1, 1, None, 1, 1, True)
    ...
    def forward(self, x):
        ...
        for i in range(self.wt_levels):
            ...
            curr_x_tag = self.wavelet_scale[i](self.wavelet_convs[i](curr_x_tag))   #self.wavelet_scale尺度调整，更好融合
...
if __name__ == '__main__':
    ...
    wtconv = wfc(in_channels=32, out_channels=32)
    output = wtconv(input)
    print(output.size())